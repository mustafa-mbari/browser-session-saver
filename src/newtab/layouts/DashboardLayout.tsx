...
import AccountPanel from '@newtab/components/AccountPanel';
...
export default function DashboardLayout() {
  ...
  const isSessionView = ['sessions', 'auto-saves', 'tab-groups', 'import-export', 'subscriptions', 'settings', 'folder-explorer', 'prompts', 'account'].includes(activeView);
